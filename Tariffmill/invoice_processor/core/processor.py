...
def process_invoice_data(
    ...
    df['SteelRatio'] = safe_get_column('steel_pct', 0.0)
    df['AluminumRatio'] = safe_get_column('aluminum_pct', 0.0)
    df['CopperRatio'] = safe_get_column('copper_pct', 0.0)
    df['WoodRatio'] = safe_get_column('wood_pct', 0.0)
    df['AutoRatio'] = safe_get_column('auto_pct', 0.0)
    df['NonSteelRatio'] = safe_get_column('non_steel_pct', 0.0)
